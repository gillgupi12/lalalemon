...
<template>
  <div
    class="md:flex flex-row text-black py-6 w-full shadow-sm hidden bg-slate-200 dark:bg-slate-200 dark:text-black px-4"
  >
    <div class="flex max-w-7xl container justify-between flex-row mx-auto">
