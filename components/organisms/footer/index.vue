...
<template>
  <div>
    ...
    <div class="bg-gray-100 py-4">
      ...
      >
        <div class="p-5">
          <h3 class="font-light text-xl text-red-600">Lalalemon</h3>
        </div>
        <div class="p-5">
          <div class="text-sm uppercase text-red-600 font-bold">Womwn</div>
          <a class="my-3 block" href="/women/new">
            New <span class="text-teal-600 text-xs p-1"></span
          ></a>
          <a class="my-3 block" href="/women/bestseller"
            >Bestseller <span class="text-teal-600 text-xs p-1"></span>
          </a>
        </div>
        <div class="p-5">
          <div class="text-sm uppercase text-red-600 font-bold">Men</div>
          <a class="my-3 block" href="/men/new"
            >New <span class="text-teal-600 text-xs p-1"></span>
          </a>
          <a class="my-3 block" href="/men/bestseller"
            >Bestseller <span class="text-teal-600 text-xs p-1"></span>
          </a>
        </div>
        <div class="p-5">
          ...
          <a class="my-3 block" href="/#"
            >XXX XXXX, XXXXXX XXXXXXX XXXXXXX, XX
            <span class="text-teal-600 text-xs p-1"></span></a
          ><a class="my-3 block" href="/#"
            >xxxxxxx@xxxxxx.com <span class="text-teal-600 text-xs p-1"></span
          ></a>
        </div>
      </div>
    </div>
      ...
      >
        <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
          <a href="/#" class="w-6 mx-1">
            <svg
              class="fill-current cursor-pointer text-gray-500 hover:text-red-600"
              width="100%"
              height="100%"
              viewBox="0 0 24 24"
              version="1.1"
